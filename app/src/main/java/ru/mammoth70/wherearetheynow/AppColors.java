...
public class AppColors {
    ...
    private static int getColorResource(String color) {
        // Метод возвращает ресурс цвета по строке с цветом.
        switch (Objects.requireNonNull(color)) {
            case (COLOR_WHITE):
    ...
    private static int getColorResourceAlpha(String color) {
        // Метод возвращает прозрачный ресурс цвета по строке с цветом.
        switch (Objects.requireNonNull(color)) {
            case (COLOR_WHITE):
                return R.color.white_alpha;
            case (COLOR_RED):
                return R.color.red_alpha;
            case (COLOR_ORANGE):
                return R.color.orange_alpha;
            case (COLOR_YELLOW):
                return R.color.yellow_alpha;
            case (COLOR_GREEN):
                return R.color.green_alpha;
            case (COLOR_DARKGREEN):
                return R.color.darkgreen_alpha;
            case (COLOR_CYAN):
                return R.color.cyan_alpha;
            case (COLOR_BLUE):
                return R.color.blue_alpha;
            case (COLOR_VIOLET):
                return R.color.violet_alpha;
            case (COLOR_MAGENTA):
                return R.color.magenta_alpha;
            default:
                return R.color.black_alpha;
        }
    }

    private static int getColorResourceAlpha16(String color) {
        // Метод возвращает очень прозрачный ресурс цвета по строке с цветом.
        switch (Objects.requireNonNull(color)) {
            case (COLOR_WHITE):
                return R.color.white_alpha16;
            case (COLOR_RED):
                return R.color.red_alpha16;
            case (COLOR_ORANGE):
                return R.color.orange_alpha16;
            case (COLOR_YELLOW):
                return R.color.yellow_alpha16;
            case (COLOR_GREEN):
                return R.color.green_alpha16;
            case (COLOR_DARKGREEN):
                return R.color.darkgreen_alpha16;
            case (COLOR_CYAN):
                return R.color.cyan_alpha16;
            case (COLOR_BLUE):
                return R.color.blue_alpha16;
            case (COLOR_VIOLET):
                return R.color.violet_alpha16;
            case (COLOR_MAGENTA):
                return R.color.magenta_alpha16;
            default:
                return R.color.black_alpha16;
        }
    }
