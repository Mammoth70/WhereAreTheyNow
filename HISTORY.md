...
Теперь в activity "Карточка контакта", в activity выбора меток и в главной activity используются те же ресурсы меток, что и в activity "Яндекс-карты".  
...
Изменена тема всех кнопок FAB в activity "Яндекс-карты". Теперь они стали более заметными.

### 3.08
На все activity добавлена кнопка "назад".

На всех activity с картами изменена тема кнопки вызова меню.

Теперь в activity "Яндекс-карты" при тапе на метку выводятся не координаты тапа, как раньше, а координаты самой метки.
...
### 3.11
Сменена нумерация версий на формат Major.Minor.Patch.
Сменена числовая нумерация версий на формат versionMajor * 10000 + versionMinor * 100 + versionPatch.  
