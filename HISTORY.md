...
Отказ от использования в файлах макетов android:onClick. Вместо этого сделаны программные установки всех листенеров через setOnClickListener.  
...
Переписан класс UsersAdapter. Из кода удалены внутренние классы футера, а в макет добавлены атрибуты paddingBottom и clipToPadding, создающие и настраивающие внутренний отступ.
...
Инициализация запроса разрешения "Работа в фоновом режиме" теперь происходит строго после одобрения разрешения "Точное местоположние".  
