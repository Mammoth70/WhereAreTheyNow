...
### 2.26
Добавлена поддержка динамического цвета, сгенерированного из обоев пользователя.  
Поэтому, теперь минимальная рабочая версия - Android 12(S).  
Добавлена жёлтая тема.  
Переписан класс SMSMonitor и метод sendSMS для Android 12.
