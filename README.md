...
- также, можно самостоятельно отправлять контактам SMS-сообщения со своей геолокацией не ожидая от них ответа.
...
В приложении поддерживается английский и русский языки.  
Поддерживается дневная, системная и ночная темы, добавлены темы с динамическим цветом.  
